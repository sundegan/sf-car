function genProto() {
    ...
    protoc -I=. --grpc-gateway_out=paths=source_relative:$GO_OUT_PATH $PROTO_FILE

    # 由Proto文件生成前端的JS/TS代码
    PBTS_OUT_DIR=../../../wx/miniprogram/service/proto_gen/${service}
    JS_FILE=${service}_pb.js
    TS_FILE=${service}_pb.d.ts
